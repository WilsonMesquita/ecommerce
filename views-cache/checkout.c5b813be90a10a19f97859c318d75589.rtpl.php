												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															<strong class="product-quantity"><?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - </strong><?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
												...
												<tfoot>
													...
													<tr class="shipping">
														...
														<td>
															...
															<input type="hidden" class="shipping_method" value="free_shipping" id="
															shipping_method_0" data-index="0" name="shipping_method[0]">
														</td>
													</tr>
